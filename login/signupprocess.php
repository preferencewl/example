...
if($row){//如果行数大于0
    echo "<script>alert('用户名已存在');setTimeout(function() {window.location.href='signup.php'},1000);</script>";
    exit;
}
...
if(!$result){
	...
	echo "<script type='text/javascript'>alert('注册成功');setTimeout(function(){ window.location.href='login.php'},2000);</script>";
